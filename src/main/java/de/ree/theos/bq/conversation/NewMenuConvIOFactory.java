...
import org.betonquest.betonquest.compatibility.packetevents.conversation.MenuConvIO;
import org.betonquest.betonquest.compatibility.packetevents.conversation.MenuConvIO.ACTION;
import org.betonquest.betonquest.compatibility.packetevents.conversation.MenuConvIO.CONTROL;
...
public class NewMenuConvIOFactory implements ConversationIOFactory {
    ...
    public ConversationIO parse(final Conversation conversation, final OnlineProfile onlineProfile) throws QuestException {
        ...
        final BiFunction<Player, ConversationAction, ConversationSession> inputFunction = (player, control)
                -> new InputEventSession(plugin, player, control);
        return new MenuConvIO(inputFunction, conversation, onlineProfile, colors, settings, componentLineWrapper, plugin,
